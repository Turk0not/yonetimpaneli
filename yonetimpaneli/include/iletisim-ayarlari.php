            ...
            if ($_POST)
            {
                if (!empty($_POST["telefon"]) && !empty($_POST["mail"]) && !empty($_POST["adres"]) && !empty($_POST["fax"]))
                {
                    ...
                    if ($guncelle!=false)
                    {
                        ...
                        <meta http-equiv="refresh" content="1; url=<?=SITE?>iletisim-ayarlari" />
                        <?php
                    ...
                    {
                        ?>
                        <div class="alert alert-danger">İşleminiz sırasında bir sorunlar karşılaşıldı. Lütfen daha sonra tekrar deneyiniz.</div>
                        <?php
                    }
                }
                else
